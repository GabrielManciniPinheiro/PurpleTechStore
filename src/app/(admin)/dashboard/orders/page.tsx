...
import { Suspense } from "react"; // 👇 Importação obrigatória para o Next.js não surtar
  ...
  return (
    <div className="flex w-full flex-col gap-10 p-10">
      ...
      <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        {/* 👇 O Suspense abraçando a barra de pesquisa resolve o sumiço */}
        <Suspense
          fallback={
            <div className="h-10 w-full max-w-sm animate-pulse rounded-md bg-zinc-800" />
          }
        >
          <OrderSearch />
        </Suspense>
